...
namespace
{
    ...
    // The bass register of "NY Excuse": mid-forward and gritty, never a clean sub.
    // The sub oscillator alone provides the low octave - stacking osc octaves on top
    // of subOctave put the sub at 13.75 Hz on a low A, which is not a note.
    const PV pNiteBass[] = {
        { "osc1Wave", SAW }, { "osc1Level", 0.95f }, { "osc1Unison", 3 }, { "osc1Detune", 0.18f },
        { "osc1Spread", 0.25f },
        { "osc2Wave", SAW }, { "osc2Level", 0.55f }, { "osc2Fine", -9.0f },
        { "subWave", 2 }, { "subOctave", -1 }, { "subLevel", 0.35f },
        { "filterMode", LP24 }, { "cutoff", 650.0f }, { "resonance", 0.35f },
        { "filterDrive", 18.0f }, { "filterEnv", 0.42f }, { "keyTrack", 0.6f },
        { "ampA", 0.001f }, { "ampD", 0.5f }, { "ampS", 0.65f }, { "ampR", 0.12f },
        { "modA", 0.001f }, { "modD", 0.16f }, { "modS", 0.2f }, { "modR", 0.1f },
        { "preDriveType", D_TUBE }, { "preDrive", 7.0f },
        { "postDriveType", D_FUZZ }, { "postDrive", 5.5f },
        { "voiceMode", MONO }, { "glide", 0.045f }, { "drift", 0.1f },
        { "pumpOn", 1 }, { "pumpDepth", 0.5f }, { "pumpShape", 0.55f }, { "pumpDivision", 8 },
        { "outputGain", -4.5f }
    };
    ...
    const PV pRaveStab[] = {
        ...
        { "osc1Spread", 0.85f },
        { "osc2Wave", SAW }, { "osc2Level", 0.4f }, { "osc2Unison", 5 }, { "osc2Detune", 0.3f },
        { "osc2Spread", 0.7f }, { "osc2Coarse", -12.0f },
        { "filterMode", LP24 }, { "cutoff", 1500.0f }, { "resonance", 0.4f },
        { "filterDrive", 6.0f }, { "filterEnv", 0.72f }, { "keyTrack", 0.4f }, { "velToCutoff", 0.35f },
        ...
        { "numVoices", 10 }, { "outputGain", -15.0f }
    };

    const PV pAcidDrive[] = {
        { "osc1Wave", SAW }, { "osc1Level", 1.0f }, { "osc1Unison", 1 },
        { "osc2Level", 0.0f }, { "subLevel", 0.1f }, { "subWave", 0 },
        { "filterMode", LP24 }, { "cutoff", 560.0f }, { "resonance", 0.86f },
        { "filterDrive", 14.0f }, { "filterEnv", 0.5f }, { "keyTrack", 0.75f },
        { "ampA", 0.001f }, { "ampD", 1.2f }, { "ampS", 0.85f }, { "ampR", 0.08f },
        { "modA", 0.001f }, { "modD", 0.33f }, { "modS", 0.0f }, { "modR", 0.2f },
        ...
        { "pumpOn", 1 }, { "pumpDepth", 0.4f }, { "pumpShape", 0.5f }, { "pumpDivision", 8 },
        { "outputGain", -5.5f }
    };
    ...
    const PV pFuzzChords[] = {
        ...
        { "filterDrive", 8.0f }, { "filterEnv", 0.4f }, { "keyTrack", 0.35f },
        ...
        { "phaserMix", 0.5f },
        { "pumpOn", 1 }, { "pumpDepth", 0.45f }, { "pumpShape", 0.5f }, { "pumpDivision", 8 },
        { "numVoices", 8 }, { "outputGain", -13.0f }
    };

    const PV pSyncScream[] = {
        { "osc1Wave", SAW }, { "osc1Level", 0.2f }, { "osc1Unison", 1 },
        { "osc2Wave", SAW }, { "osc2Level", 0.95f }, { "osc2Unison", 1 }, { "osc2Sync", 1 },
        { "osc2Coarse", 17.0f },
        { "filterMode", LP24 }, { "cutoff", 6000.0f }, { "resonance", 0.2f },
        { "filterDrive", 5.0f }, { "filterEnv", 0.2f }, { "keyTrack", 0.4f },
        { "ampA", 0.002f }, { "ampD", 0.5f }, { "ampS", 0.7f }, { "ampR", 0.2f },
        { "modA", 0.002f }, { "modD", 0.5f }, { "modS", 0.4f }, { "modR", 0.4f },
    ...
    const PV pRingMetal[] = {
        ...
        { "ringLevel", 0.75f },
        { "filterMode", BP24 }, { "cutoff", 1400.0f }, { "resonance", 0.55f },
        ...
        { "delayOn", 1 }, { "delaySync", 1 }, { "delayDivision", 7 }, { "delayFeedback", 0.45f },
    ...
    const PV pJunoPad[] = {
        ...
        { "osc2Wave", SAW }, { "osc2Level", 0.35f }, { "osc2Octave", -1 },
        { "subLevel", 0.2f },
        { "filterMode", LP24 }, { "cutoff", 2600.0f }, { "resonance", 0.15f },
        { "filterDrive", 2.0f }, { "filterEnv", 0.3f }, { "keyTrack", 0.4f },
    ...
    const PV pPumpSaws[] = {
        ...
        { "delayMix", 0.22f },
        { "numVoices", 10 }, { "outputGain", -12.5f }
    };

    const PV pSubThump[] = {
        { "osc1Wave", TRI }, { "osc1Level", 0.5f },
        { "osc2Level", 0.0f },
    ...
    const PV pNoiseSweep[] = {
        ...
        { "filterMode", BP12 }, { "cutoff", 450.0f }, { "resonance", 0.75f },
        { "filterDrive", 3.0f }, { "filterEnv", 0.5f },
        { "ampA", 0.02f }, { "ampD", 3.0f }, { "ampS", 0.6f }, { "ampR", 1.2f },
        { "modA", 2.5f }, { "modD", 2.5f }, { "modS", 0.15f }, { "modR", 1.5f },
        { "phaserOn", 1 }, { "phaserRate", 0.15f }, { "phaserDepth", 0.9f }, { "phaserMix", 0.6f },
        { "numVoices", 4 }, { "outputGain", -7.5f }
    };

    // Electroclash noise clap: a BP-filtered noise burst with a hard edge.
    const PV pElectroClap[] = {
        { "osc1Level", 0.0f }, { "osc2Level", 0.0f }, { "noiseLevel", 0.9f },
        { "filterMode", BP12 }, { "cutoff", 1100.0f }, { "resonance", 0.5f },
        { "filterEnv", 0.3f },
        { "ampA", 0.001f }, { "ampD", 0.12f }, { "ampS", 0.0f }, { "ampR", 0.08f },
        { "modA", 0.001f }, { "modD", 0.08f }, { "modS", 0.0f }, { "modR", 0.06f },
        { "preDriveType", D_HARD }, { "preDrive", 8.0f },
        { "numVoices", 8 }, { "outputGain", -4.5f }
    };

    // Short bleepy mono line - the "Compute" hook register.
    const PV pComputeBleep[] = {
        { "osc1Wave", TRI }, { "osc1Level", 0.9f },
        { "osc2Level", 0.0f },
        { "filterMode", LP24 }, { "cutoff", 2500.0f }, { "resonance", 0.1f },
        { "ampA", 0.001f }, { "ampD", 0.18f }, { "ampS", 0.0f }, { "ampR", 0.12f },
        { "modA", 0.001f }, { "modD", 0.1f }, { "modS", 0.0f }, { "modR", 0.1f },
        { "delayOn", 1 }, { "delaySync", 1 }, { "delayDivision", 5 },
        { "delayFeedback", 0.4f }, { "delayMix", 0.3f }, { "delayPingPong", 1 },
        { "outputGain", -4.0f }
    };
